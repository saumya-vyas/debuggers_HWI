  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-actions">
        {/* Add New Crop Button - Full Row */}
        <button 
          className="add-new-crop-full-width-btn"
          onClick={() => setShowNewCropForm(!showNewCropForm)}
        >
          {showNewCropForm ? 'Cancel Add Crop' : '🌱 Add New Crop'}
        </button>
      </div>
      ...
      {showNewCropForm && (
        <div className="dashboard-card full-width-card">
          <div className="card-header">
            <h3>Enter New Crop Details</h3>
            <button 
              className="toggle-btn"
              onClick={() => setShowNewCropForm(false)}
            >
              Cancel
            </button>
          </div>
      ...
      {/* My Farms Button - Full Row */}
      <div className="dashboard-actions">
        <Link to="/my-farms" className="my-farms-full-width-btn">
          🏡 View My Farms
        </Link>
      </div>
    </div>
